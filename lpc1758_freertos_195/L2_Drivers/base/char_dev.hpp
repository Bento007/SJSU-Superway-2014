...
class CharDev
{
    public:
         ...
         */
        inline uint16_t getPrintfMemSize(void) const { return msPrintfMemSize; }
    ...
    private:
        static char *mspPrintfMem;                  ///< Heap pointer used by printf()
        static uint16_t msPrintfMemSize;            ///< Size of heap used by printf()
        static SemaphoreHandle_t msPrintfSemaphore; ///< Semaphore to lock printf()
