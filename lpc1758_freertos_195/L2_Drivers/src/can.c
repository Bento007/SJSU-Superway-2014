...
static QueueHandle_t g_can_rx_qs[can_max-1] = { NULL, NULL };   ///< RX queue handles for CAN BUSes
static QueueHandle_t g_can_tx_qs[can_max-1] = { NULL, NULL };   ///< TX queue handles for CAN BUSes
static can_callbacks_t g_can_callbacks[can_max-1]  = { {NULL, NULL}, {NULL, NULL} }; ///< Callback functions
/** @{ Private functions */
