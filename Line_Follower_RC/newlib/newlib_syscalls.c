...
void *__dso_handle = 0;
static char_func_t m_output_dev_fptr = 0; ///< Function pointer for output function
static char_func_t m_input_dev_fptr = 0;  ///< Function pointer for input function

void sys_set_outchar_func(char_func_t func)
{
    m_output_dev_fptr = func;
}
void sys_set_inchar_func(char_func_t func)
{
    m_input_dev_fptr = func;
}
...
{
    int i = 0;
    if (m_output_dev_fptr)
    {
        for (i = 0; i < len; i++)
        {
            m_output_dev_fptr(*ptr++);
        }
    }
    return len;
}
