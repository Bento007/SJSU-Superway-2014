...
volatile DSTATUS m_disk_status = STA_NOINIT; /* Disk status */
...
void power_off(void)
{
    ...
    m_disk_status |= STA_NOINIT; // Set STA_NOINIT
}
...
DSTATUS sd_initialize()
{
    ...
    if (m_disk_status & STA_NODISK)
    {
        return m_disk_status; /* No card in the socket */
    }
    ...
    { /* Initialization succeded */
        m_disk_status &= ~STA_NOINIT; /* Clear STA_NOINIT */
        FCLK_FAST();
    }
    else
