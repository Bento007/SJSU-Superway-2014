 ...
 *
 * 02152014     : Added add/get sharedHandles() by index (faster).
 *                Made some functions static with documentation on how to use them.
 * 02112014     : Fixed bug with statistical update (ticks to ms conversion)
...
class scheduler_task
{
    public :
        ...
        uint8_t getSysCpuPercent (void) const;  ///< Get total system CPU percent
         ...
         *     xQueueHandle sensor_queue = getSharedObject("senqueue");
         * @endcode
         *
         * @note
         * These functions are declared static because that way, any code in any context
         * can get a shared object.  So maybe a terminal command can get a shared object
         ...
         *     xQueueHandle qh = getSharedObject(shr_Queue);
         * @endcode
         *
         * @note
         * These functions are declared static because that way, any code in any context
